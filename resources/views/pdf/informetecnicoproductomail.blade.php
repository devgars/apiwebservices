    ...
    <div class=" ">
        <table class="table" width="100%" border="0" style="border:1px solid #000" >
            <tbody class="border" >
                <tr>
                    ...
                    <td colspan="2">
                        <p class="text-center" >{{$rsDataInforme['NumRquest']}}</p>
                    </td>
                </tr>
                <tr>
        ...
        <table class="table m-b-10" width="100%" border="0" >
            <tbody class="" >
                <tr >
                    ...
                    <td class="">
                        <p class="m-b-10 m-t-10 text-end fs-18" >Lima, {{$rsDataInforme['DayNow']}}</p>
                    </td>
                </tr>
                <tr class="m-t-30">
                    <td class=""  >
                        <p class="m-b-10 m-t-10 text-start fs-18" >  INFORME N° {{$rsDataInforme['NumRquest']}} / {{$rsDataInforme['id']}} M&M </p>
                    </td>
                    <td class=""> </td>
                </tr>
            </tbody>
        ...
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                <tr >
                    ...
                    <td class="">
                        <p class="bold text-center" >{{$rsDataInforme['NameClient']}}</p>
                    </td>
                    <td class="">
                        <p class="" >RUC:</p>
                    </td>
                    <td class=""> 
                        <p class="bold text-center" > {{$rsDataInforme['Document']}} </p>
                    </td>
                    <td class="">
                        <p class="" >Cod. Cliente:</p>
                    </td>
                    <td class="">
                        <p class="bold text-center" >{{$rsDataInforme['code_cli']}}</p>
                    </td>
                </tr>
                <tr >
                    <td class=""  >
                    ...
                    <td class="" colspan="2"> 
                        <p class="bold text-center" >{{$rsDataInforme['serie_description']}} - {{$rsDataInforme['num_comprobante']}}</p>
                    </td>
                    <td class="" >
                        <p class="" >Fecha Comp.:</p>
                    </td>
                    <td class="" colspan="2" >
                        <p class="bold text-center" >{{$rsDataInforme['fac_date_emision']}}</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table p-t-25" width="100%" border="0" >
            <tbody class="border" >
                <tr >
                    ...
                    <td class="">
                        <p class="text-center" > {{$rsDataInforme["descripcion_prod"]}}</p>
                    </td>
                    <td class="">
                        <p class="" >Cantidad</p>
                    </td>
                    <td class="">
                        <p class="text-center" >{{$rsDataInforme["unit_proc"]}}</p>
                    </td>
                    <td class="">
                        <p class="" >Línea:</p>
                    </td>
                    <td class="">
                        <p class=" text-center" > {{$rsDataInforme["line_code"]}}</p>
                    </td>
                </tr>
                <tr >
                    <td class=""  >
                    ...
                    <td class="">
                        <p class="bold text-center" >{{$rsDataInforme["code"]}} </p> 
                    </td>
                    <td class="" >
                        <p class="" >Marca</p>
                    </td>
                    <td class="" >
                        <p class="bold text-center" >{{$rsDataInforme["brand"]}}</p> 
                    </td>
                    <td class="" >
                        <p class="" >Cod. Fabricante</p>
                    </td>
                    <td class=""  >
                        <p class="bold text-center" >{{$rsDataInforme["factory_code"]}}</p> 
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                ...
                <tr >
                    <td class=""  >
                        <p class="p-5" >{{$rsDataInforme["detail_init"]}}</p>
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                ...
                <tr>
                    <td colspan="2" >
                        <p class="p-5"  > {{$rsDataInforme["detail"]}} </p>
                    </td>
                </tr>
                ...
                @php
                    $counter = 0;
                @endphp
                @foreach ($rsDataInforme['arrayFinalFiles'] as $valor)
                    <tr>
                        @foreach ($valor['dato'] as $valores)
                            @if($valores["id_product_detail_request"]===$rsDataInforme['id'])
                                @php
                ...
                <tr>
                    <td colspan="2" >
                        <p class="p-5 "  > <b class="bold">Evidencia: </b> {{$rsDataInforme["evidence"]}} </p>
                    </td>
                </tr>
            </tbody>
        </table>
        @if($rsDataInforme["motivo"] !=='FALLA DE FÁBRICA') 
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                <tr >
                    <td>
                ...
                <tr>
                    <td >
                        <p class="p-5"  >{{$rsDataInforme["cause_failure"]}} </p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                ...
                <tr>
                    <td >
                        <p class="p-5"  > {{$rsDataInforme["conclusion_detail"]}} </p>
                    </td>
                </tr>
                <tr>
                    <td >
                        <p class="bold  fs-14" >{{$rsDataInforme["motivo"]}}</p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table p-t-20" width="100%" border="0" >
            <tbody class="border" >
                ...
                <tr>
                    <td >
                        <p class="p-5"  > {{$rsDataInforme["recommendations"]}} </p>
                    </td>
                </tr>
            </tbody>
        </table>
